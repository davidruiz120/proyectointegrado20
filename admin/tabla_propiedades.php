...
?>
  ...
  <title>Forza ATAX | Tabla propiedades</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tabla propiedades</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Información de las propiedades</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">  
                  ...
                  <tbody id="tablaPropiedades">
                    ...
                    <!-- El archivo js/aPropiedades.js es el encargado de rellenar esta tabla -->
  ...
  <!-- Script propio -->
  <script src="js/aPropiedades.js"></script>
